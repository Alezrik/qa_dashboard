defmodule QaDashboard.Accounts.User do
  @moduledoc false
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, QaDashboard.Repo)
  ...
  """
  def valid_password?(%QaDashboard.Accounts.User{hashed_password: hashed_password}, password)
